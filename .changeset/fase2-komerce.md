---
'@ongkir-sdk/core': minor
'@ongkir-sdk/komerce': minor
---

Add `@ongkir-sdk/komerce` adapter (unofficial RajaOngkir API V2 by Komerce): getRates (postal-code based), trackShipment (requires courier code), webhook not supported in the target tier.
