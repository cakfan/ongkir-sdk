import type { RateRequest, RateResult, ShippingProvider, TrackingResult, WebhookEvent } from '@ongkir-sdk/core'
...
import type { BiteshipRateResponse, BiteshipTrackingResponse, BiteshipWebhookPayload } from './mapper'
